<h2><a href="https://leetcode.com/problems/decoded-string-at-index/solutions/?envType=problem-list-v2&envId=stack">916. Decoded String at Index</a></h2><h3>Medium</h3><hr><p>You are given an encoded string <code>s</code>. To decode the string to a tape, the encoded string is read one character at a time and the following steps are taken:</p>
